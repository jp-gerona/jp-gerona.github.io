  ...
  >
    ...
    >
      ...
      <div style="display: flex; flex-direction: column; gap: 12px; max-width: 920px;">
        <div style="font-size: 46px; color: #8a8a8a; line-height: 1.1;">${authorOrBrand}</div>
        <div style="font-size: 72px; color: #ffffff; line-height: 1.2;">${title}</div>
      </div>
    </div>
  </div>`;
}
